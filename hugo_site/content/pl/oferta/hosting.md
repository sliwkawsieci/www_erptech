...
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <h3 class="text-lg font-bold text-gray-900 mb-2">Bezpieczeństwo</h3>
    <p class="text-gray-600">Szyfrowanie SSL, firewall, regularne backupy i monitoring 24/7</p>
</div>
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <h3 class="text-lg font-bold text-gray-900 mb-2">Wydajność</h3>
    <p class="text-gray-600">Szybkie serwery SSD, optymalizacja bazy danych i cache</p>
</div>
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <h3 class="text-lg font-bold text-gray-900 mb-2">Niezawodność</h3>
    <p class="text-gray-600">SLA 99.9% dostępności, redundancja i disaster recovery</p>
</div>
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <h3 class="text-lg font-bold text-gray-900 mb-2">Aktualizacje</h3>
    <p class="text-gray-600">Regularne aktualizacje systemu i zabezpieczeń</p>
</div>
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <h3 class="text-lg font-bold text-gray-900 mb-2">Wsparcie</h3>
    <p class="text-gray-600">Dedykowane wsparcie techniczne od ekspertów ERPnext</p>
</div>
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
    ...
    <h3 class="text-lg font-bold text-gray-900 mb-2">Skalowalność</h3>
    <p class="text-gray-600">Elastyczne zasoby rosnące wraz z Twoją firmą</p>
</div>
</div>
...
<div class="grid md:grid-cols-2 gap-6">
    <div>
        <h4 class="font-bold text-gray-900 mb-4">Infrastruktura</h4>
        <ul class="space-y-3">
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span class="text-gray-700">Serwery w europejskich data center</span>
            </li>
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span class="text-gray-700">Dyski SSD NVMe</span>
            </li>
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span class="text-gray-700">Dedykowane zasoby CPU i RAM</span>
            </li>
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span class="text-gray-700">Własna domena i certyfikat SSL</span>
            </li>
        </ul>
    </div>
    <div>
        <h4 class="font-bold text-gray-900 mb-4">Zarządzanie</h4>
        <ul class="space-y-3">
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span class="text-gray-700">Codzienne backupy</span>
            </li>
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
            ...
            <li class="flex items-center gap-3">
                ...
                <span class="text-gray-700">Automatyczne aktualizacje bezpieczeństwa</span>
            </li>
            <li class="flex items-center gap-3">
                <svg class="w-5 h-5 text-green-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span class="text-gray-700">Środowisko testowe (opcjonalnie)</span>
            </li>
        </ul>
    </div>
</div>
...
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
    ...
    <a href="/kontakt/" class="block text-center bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 px-4 rounded-lg transition-colors">
        Zapytaj o cenę
    </a>
</div>

<div class="bg-white p-6 rounded-xl shadow-md border-2 border-blue-400 hover:shadow-lg transition-shadow relative">
    <div class="absolute -top-3 left-1/2 transform -translate-x-1/2">
        <span class="bg-blue-500 text-white text-xs font-bold px-3 py-1 rounded-full">POPULARNY</span>
    </div>
    <div class="text-center mb-6">
    ...
    <a href="/kontakt/" class="block text-center bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors">
        Zapytaj o cenę
    </a>
</div>
...
<div class="bg-gradient-to-br from-gray-900 to-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow text-white">
    ...
    <a href="/kontakt/" class="block text-center bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-4 rounded-lg transition-colors">
        Zapytaj o cenę
    </a>
</div>
</div>
...
<div class="max-w-3xl mx-auto">
    <h3 class="text-3xl md:text-4xl font-bold text-white mb-6">
        Zainteresowany hostingiem ERPnext?
    </h3>
    <p class="text-xl text-white/90 mb-8 leading-relaxed">
        Skontaktuj się z nami, aby otrzymać indywidualną wycenę dopasowaną do Twoich potrzeb.
    </p>
